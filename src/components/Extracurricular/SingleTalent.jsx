...
const SingleTalent = ({ heading, description, url }) => {
    return (
        <article className=' lg:h-[580px] md:h-[450px] md:w-[300px] lg:w-[440px] w-[330px] h-[460px] p-4 py-8 flex flex-col justify-between border-2 border-secondary items-center rounded-xl mx-4'>
            ...
            {heading === 'Actor, Playwright, Director and Activist' && <p className='text-gray text-[18px] font-quicksand font-[400] flex-1 pt-[72px]'>
            Directed, wrote and acted in multiple plays, leading teams of 5+ individuals for memorable performances.
            </p> }
