...
const HomeArticle = () => {
    return (
        <article className='lg:max-w-full lg:p-4 p-8 w-full flex flex-col justify-center items-center bg-primary'>
            <h1 className='font-libre text-[30px] md:text-[60px] sm:text-[36px] uppercase font-[700] text-secondary drop-shadow-lg tracking-wide mb-[40px] mix-blend-luminosity'>Arayna Saxena</h1>
