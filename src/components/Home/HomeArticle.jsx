...
const HomeArticle = () => {
    return (
        <article className='lg:max-w-full lg:p-4 p-8 w-full flex flex-col justify-center items-center bg-primary relative'>
            ...
            <br />
            <a href=' ' rel="noreferrer" target='_blank' className='text-secondary text-[18px] font-monserrat font-[600] w-full lg:w-[750px] mb-[58px]'>
                Click below for my complete resume, or click through the tabs to find further details!
            </a>
            <br />
            <button className='w-[142px] flex items-center gap-4 p-3 bg-purple rounded-sm shadow-md transition text-primary hover:bg-primary hover:text-secondary font-serif font-[700] text-[14px]  mt-4 '>
