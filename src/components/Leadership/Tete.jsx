                ...
                <div className='flex flex-col gap-4 md:w-2/5 w-full'>
                    ...
                    <div className='gap-2 p-2 bg-purple/80 rounded-md '>
                        <p className='overflow-hidden'>
                            <a href="https://www.facebook.com/watch/live/?ref=watch_permalink&v=591628439276800z" className='mr-2 underline text-white hover:text-dark-gray font-roboto font-[100] '>Interview - Mr. Kailash Satyarthi</a>
                            <br />   
                            <a href="https://www.facebook.com/watch/live/?ref=watch_permalink&v=434550201080202" className='mr-2 underline text-white hover:text-dark-gray font-roboto font-[100] '>Interview - Mr. Ronit Ranjan</a>
                            <br />
                            <a href="https://www.facebook.com/watch/live/?ref=watch_permalink&v=1519231721800730" className='mr-2 underline text-white hover:text-dark-gray font-roboto font-[100] '>Interview - Sr. Adv. Sidharth Luthra</a>
                            <br />
                        </p>
                    </div>
                </div>
