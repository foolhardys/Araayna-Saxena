...
const Gamechanger = () => {
    return (
        <article className='max-w-[1280px] my-4 pb-[220px] rounded-lg shadow-lg bg-light-gray min-h-[50vh] p-8 flex md:flex-row flex-col justify-between items-center gap-5  bg-gray-white-bg/5'>
