    ...
    <article className='md:h-[434px] gap-10 rounded-md shadow-lg lg:w-[1280px] flex nd:gap-5 px-10 py-4 justify-center items-center mt-4 md:flex-row flex-col md:mb-0 mb-4'>
      <div>
        ...
        <button className='bg-purple rounded-md  p-3 hover:bg-lightpurple hover:text-dark-gray text-white'>
          <a href="https://drive.google.com/file/d/1Yzq_GR0IAQqnljc7KAGxz6OorYdh2jDq/view?usp=drive_link" className='text-[18px] font-quicksand font-[700]' target='_blank' rel="noreferrer">Check out my projects</a></button>
      </div>
      <div>
