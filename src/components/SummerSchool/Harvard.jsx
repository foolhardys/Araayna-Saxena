...
const Harvard = () => {
  return (
    <article className='md:h-[434px] gap-10 rounded-md shadow-lg lg:w-[1280px] flex nd:gap-5 px-10 py-4 justify-center items-center mt-4 md:flex-row flex-col mb-40 bg-light-gray'>
    <div>
    ...
    <div>
      <img src={Image} alt="Web development certificate" className='h-[346px] shadow-lg rounded-md' />
    </div>
  </article>
  )
}
