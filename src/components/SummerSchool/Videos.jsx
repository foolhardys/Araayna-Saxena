    ...
    <article className='lg:w-[1280px] mt-4 w-full'>
      ...
      <div className='flex gap-5 px-10 py-4 justify-start items-center md:flex-row flex-col'>
        <button className='w-[300px] bg-lightpurple rounded-xl flex justify-between items-center p-4 md:h-[100px] h-[100px]'>
          <a href="" className='font-quicksand font-[500] text-[18px]'>Is Brown Pre-college Program <strong>WORTH IT</strong>? Academic Course Review!</a>
          <img src={Vector} alt="" />
        </button>
        <button className='w-[300px] bg-lightpurple rounded-xl flex justify-between items-center p-4 md:h-[100px] h-[100px]'>
          <a href="" className='font-quicksand font-[500] text-[18px]'>Reading MY POEM at <strong>BROWN UNIVERSITY!!</strong> </a>
          <img src={Vector} alt="" />
        </button>
      </div>
    </article>
