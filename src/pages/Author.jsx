            ...
            <div className="flex lg:flex-row flex-col">
              <div className="w-full flex-1 relative pt-[5em]" >
                <div className='ml-[100px] flex flex-col justify-center'>
                  <h1 className='md:text-[90px] text-[60px] text-left ml-[0px] leading-[60px] font-[500] relative font-courier'>The story</h1>
                  <div className="grid mt-[10px] ml-[90px]"><img src={One} alt="" /></div>
                  <h1 className='md:text-[90px] text-[60px] text-left leading-t[40px] font-[500] font-courier'>behind my</h1>
                  <h1 className='md:text-[90px] text-[60px] text-left leading-t[40px] font-[500] font-courier'>book</h1>
                </div>
          ...
          <div>
            <div className="flex lg:flex-row flex-col">
              ...
              <div className='w-full flex-1 md:px-32 px-5 pb-[100px] pt-[20px]'>
                ...
                <div className="grid relative">
                  <img src={Twelve} alt="" className='absolute right-0 mr-[200px] -translate-y-10' />
                </div>
                <h3 className='text-justify font-[400] text-[24px] mt-[1.3em] font-serif'>
                  The entire process was indeed challenging, where I had to meet academic deadlines and, at the same time, edit, design, and compile the script for my book.
                </h3>
                ...
                <h3 className='text-right font-[700] text-[24px] mt-[1.3em] font-serif'>
...
{/* <div>
<div className=" story_p2">
  <div className="container text-center ">
    <div className="row">
      <div className="col" style="margin-top: 5em;">
        <div className="s1_p1"><img src="./svgs/story_page_2_man.png" alt="" /></div>
        <div className="s1_p2_rd"><img id="new" src="./svgs/story_page_2_random.png" alt="" />
          <img id="p3" src="./svgs/story_page_2_flower.png" alt="" />
        </div>
      </div>
      <div className="col story_2_cnt">
        <h3>
          In her eyes was pride, and this had been eternally imprinted in my brain as the day that
          motivated me to discover my passions and work towards them to positively impact people
          around me and feel proud of myself. Later, the school converted my poem into a song which
          was sung at our annual function. This new experience encouraged me to continue exploring and
          learning.
        </h3>
        <h3>
          Throughout middle school, I received much support and inspiration for my academic pursuits,
          literary skills, and extracurricular activities. I reached 9th grade in the middle of a
          pandemic during which I became more observant of the people around me and the various
          actions that drove them to feel any emotion. Soon I decided to write a book that would be a
          collection of poetry that dealt with various themes so people anywhere in the world could
          connect with my poems offering a change in perspective & support.
        </h3>
        <h3>
          The entire process was indeed challenging, where I had to meet academic deadlines and, at
          the same time, edit, design, and compile the script for my book.
        </h3>
        <div className="s1_p2_cnt_p1">
          <img src="./svgs/story_page_2_cnt_p1.png" alt="" />
        </div>
      </div>
    </div>
  </div>
...
<div className="story_p3">
<div className="container text-center ">
  <div className="row">
    <div className="col" style="margin-top: 5em;">
      <div className="s1_p1"><img src="./svgs/story_page_3_cloud.png" alt="" /></div>
      <div className="s1_p3_bk">
        <img id="p4" src="./svgs/story_page_3_flower.png" alt="" />
        <img src="./svgs/story_page_3_book_fly.png" alt="" />
      </div>
    </div>
    <div className="col story_2_cnt">
      <h3>
        <span>
          Finally, "Amidst The Downpour" was ready as a downpour of my thoughts and emotions over
          paper. The honourable Governor of Madhya Pradesh agreed to inaugurate my book during the
          book launch, and people from different educational fields and careers attended it."
          <img id="p6" src="./svgs/story_page_3_cnt_col.jpg" alt="" />
        </span>
      </h3>
      <h3>
        I have always been passionate about poetry and storytelling. I think of myself as a curious
        Author who loves exploring different themes and motifs which reflects in my poems. As part of my
        writing process, I loves immersing myself in my work-diving headfirst into the imagination,
        writing and fine-tuning of the stories I feel are the most worthy of telling. This book remains
        very close to my heart as it comprises poems I have been writing and treasuring in a small
        notebook my mom gifted me to now when I finally felt that my poems could be given a home in this
        book.
      </h3>
      <h3 id="f_quote">
        The incident that lead to amidst the downpour
...
<div className="con_head1">
  <p>Email Address</p>
</div>
<div className="con_head2">
  <p>arayna.downpour@gmail.com</p>
</div>
</div>
</ > */}