          ...
          <div>
            <div className="flex lg:flex-row flex-col">
              ...
              <div className='w-full flex-1 mt-[3vh] md:px-32 px-5 py-2'>
                ...
                <h3 className='text-justify font-[400] text-[22px] mt-[2em] font-serif'>
                ...
                <h3 className='text-justify font-[400] text-[22px] mt-[1.3em] font-serif'>
                ...
                <div className="grid h-[35px]">
                  <img src={Thirteen} alt="" className='absolute left-[15px] -translate-y-[210px]' />
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="flex lg:flex-row flex-col">
              ...
              <div className='w-full flex-1 md:px-32 px-5 pb-[100px] pt-[20px]'>
                ...
                <h3 className='text-right font-[700] text-[22px] mt-[1.3em] font-serif'>
