...
const Bharatnatyam = () => {
  return (
    <article className=' py-2 w-[1280px] shadow-xl rounded-3xl flex flex-col items-center mt-20 mb-20 '>
      ...
      <div className='w-full flex justify-center min-h-[300px] items-start gap-5 lg:flex-row flex-col mb-10'>
