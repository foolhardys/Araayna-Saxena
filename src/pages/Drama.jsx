...
const Drama = () => {
  return (
    <article id='drama' className='lg:w-[1280px] w-full shadow-xl rounded-3xl flex flex-col items-center justify-center mb-20'>
...
' />
        <YoutubePlayer url='https://www.youtube.com/embed/oZMzRjHqQCI?si=A1STtB0lrP2Ex3SU'/>
